      ...
      parameters: {
        ...
        properties: {
          ...
          channels: { 
            ...
            description: "Các kênh cần tạo content (mặc định: facebook, instagram)" 
          },
          content_goal: { 
            type: "string", 
            enum: ["engagement", "awareness", "conversion", "education", "expertise"],
          ...
          auto_research: {
            type: "boolean",
            description: "Tự động nghiên cứu trending trước khi tạo. Mặc định: false"
          }
        },
