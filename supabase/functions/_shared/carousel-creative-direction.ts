...
const ARCHETYPE_SPECS: Record<TypographyArchetype, ArchetypeSpec> = {
  'editorial-hero': {
    displayFont: 'high-contrast modern serif (Fraunces / GT Sectra / Playfair) with delicate brackets and oldstyle figures',
    bodyFont: 'neo-grotesk with refined letter spacing (Söhne / GT America)',
    ratio: '8:1',
  ...
  'data-display': {
    displayFont: 'condensed bold display (Archivo Black / Bebas Neue / Druk Wide) for the numeral',
    bodyFont: 'monospace label (IBM Plex Mono / Söhne Mono)',
    ratio: '12:1',
  ...
  'supporting-body': {
    displayFont: 'neo-grotesk bold (Söhne Bold / GT America Bold) — NOT Inter, NOT Helvetica',
    bodyFont: 'neo-grotesk regular with refined letter spacing — NOT Inter UI default',
    ratio: '3:1',
  ...
  'cta-poster': {
    displayFont: 'massive condensed sans (Druk Wide / Anton / Knockout)',
    bodyFont: 'neo-grotesk medium (Söhne Medium / GT America Medium)',
    ratio: '6:1',
  ...
  'caption-only': {
    displayFont: 'neo-grotesk medium (no display font used)',
    bodyFont: 'neo-grotesk medium (Söhne Medium)',
    ratio: '1:1',
