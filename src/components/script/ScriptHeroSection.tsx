...
export function ScriptHeroSection({
  ...
  const stats = useMemo(() => {
    ...
    // Count recent scripts (last 7 days)
    const now = new Date();
    const last7Days = new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000);
    const recentCount = scripts.filter(s => new Date(s.created_at) > last7Days).length;

    return { total, published, review, draft, completionRate, recentCount };
  }, [scripts]);
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          >
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Tổng kịch bản</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-yellow-500">{stats.review + stats.draft}</p>
              ...
              <div className="relative w-12 h-12">
                <svg className="w-full h-full -rotate-90" viewBox="0 0 80 80">
                  ...
                  <motion.circle
                    ...
                    r={radius}
                    fill="none"
                    stroke="url(#scriptProgressGradient)"
                    strokeWidth="6"
                    strokeLinecap="round"
                  ...
                  />
                  <defs>
                    <linearGradient id="scriptProgressGradient" x1="0%" y1="0%" x2="100%" y2="0%">
