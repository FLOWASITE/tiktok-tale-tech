...
const PersonaCard = ({ persona }: { persona: CustomerPersona }) => {
  ...
  return (
    <Card className={cn(
      ...
      persona.is_primary && "ring-2 ring-primary"
    )}>
      {/* Primary Badge */}
      {persona.is_primary && (
        <div className="absolute top-0 right-0">
          <div className="bg-primary text-primary-foreground text-xs font-medium px-2 py-0.5 rounded-bl-md flex items-center gap-1">
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start gap-3">
          {/* Avatar */}
          <div className="w-14 h-14 rounded-full bg-muted flex items-center justify-center text-3xl shrink-0 ring-2 ring-border">
      ...
      <CardContent className="space-y-4 pt-0">
        ...
        {persona.desires.length > 0 && (
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1">
              {persona.desires.slice(0, 3).map((desire, idx) => (
        ...
        {persona.objections.length > 0 && (
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1">
              {persona.objections.slice(0, 2).map((obj, idx) => (
        ...
        {(persona.values.length > 0 || persona.interests.length > 0) && (
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1">
              {[...persona.values.slice(0, 2), ...persona.interests.slice(0, 2)].map((item, idx) => (
        ...
        {persona.buying_triggers.length > 0 && (
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1">
              {persona.buying_triggers.slice(0, 3).map((trigger, idx) => (
