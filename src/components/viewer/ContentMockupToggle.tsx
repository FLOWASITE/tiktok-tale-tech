...
const channelToMockupType: Record<Channel, 'facebook' | 'linkedin' | 'instagram' | 'tiktok' | 'email' | 'twitter' | 'threads' | 'pinterest' | 'bluesky' | 'blogger' | 'wordpress' | 'shopify' | 'wix' | 'medium' | 'general'> = {
  facebook: 'facebook',
  linkedin: 'linkedin',
  instagram: 'instagram',
  pinterest: 'pinterest',
...
export function ContentMockupToggle({
  ...
  const isWebsiteLike = channel === 'website' || channel === 'blogger' || channel === 'wordpress' || channel === 'shopify' || channel === 'wix' || channel === 'medium';
