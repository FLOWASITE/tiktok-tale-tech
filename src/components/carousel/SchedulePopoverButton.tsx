                ...
                return (
                  <button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      if (isConnected) setSelectedChannel(ch);
                    }}
                    ...
                    className={cn(
                      'w-8 h-8 rounded-full flex items-center justify-center transition-all relative touch-manipulation',
                  ...
                  >
                    <ChannelIcon channel={ch as Channel} className="h-3.5 w-3.5" size={14} />
                    {existingSch && (
