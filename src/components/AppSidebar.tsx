import { Film, Images, Bookmark, Layers, LayoutDashboard, Shield, LogOut, ChevronUp, CalendarDays, History } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Lịch sử đăng bài', url: '/publishing-history', icon: History },
