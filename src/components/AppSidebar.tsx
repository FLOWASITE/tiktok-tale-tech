            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild tooltip="Admin Dashboard">
                      ...
                      >
                        ...
                        <span className={isCollapsed ? 'sr-only' : ''}>Dashboard</span>
                      </NavLink>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild tooltip="Countries">
                      ...
                      >
                        ...
                        <span className={isCollapsed ? 'sr-only' : ''}>Countries</span>
                      </NavLink>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild tooltip="Memory Packs">
                      <NavLink
                        to="/admin/packs"
                        className="flex items-center gap-3 text-primary/80 hover:text-primary transition-colors"
                        activeClassName="bg-primary/10 text-primary font-medium"
                      >
                        ...
                        <span className={isCollapsed ? 'sr-only' : ''}>Memory Packs</span>
                      </NavLink>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
