...
function getContentForChannel(content: MultiChannelContent, channel: Channel): string | null {
  switch (channel) {
    ...
    case 'shopify': return content.shopify_content;
    case 'wix': return content.wix_content;
    case 'medium': return content.medium_content;
          ...
          {!isEditingHeader && (
            <div className="px-4 py-2 border-b border-border/50 bg-muted/10 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide">
                ...
                {/* Expand Channels */}
                {onExpandChannels && (() => {
                  const ALL_CHANNELS: Channel[] = ['website', 'blogger', 'facebook', 'instagram', 'twitter', 'linkedin', 'youtube', 'email', 'google_maps', 'zalo_oa', 'telegram', 'tiktok', 'threads'];
