...
const svgIcons: Partial<Record<Channel, React.FC<{ className?: string }>>> = {
  ...
  zalo_oa: ({ className }) => (
    <svg className={className} viewBox="0 0 48 48" fill="currentColor">
      <path d="M24 4C12.954 4 4 11.85 4 21.5c0 5.49 2.93 10.38 7.5 13.56V44l7.34-4.04c1.66.32 3.39.5 5.16.5 11.046 0 20-7.85 20-17.46S35.046 4 24 4z"/>
