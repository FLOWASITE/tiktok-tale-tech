            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:w-auto">
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-[200px]">
                  <p className="text-sm">Tiến độ hoàn thành các mục tiêu KPI đề ra cho chiến dịch này</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-[200px]">
                  <p className="text-sm">Tổng ngân sách và số tiền đã chi cho chiến dịch</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="p-4 rounded-xl bg-muted/50 text-center cursor-help">
                    <div className="flex items-center justify-center gap-1 mb-1">
                      ...
                      <span className="text-xs text-muted-foreground">Mốc</span>
                      <HelpCircle className="h-3 w-3 text-muted-foreground/50" />
                    </div>
                    <p className="text-2xl font-bold">
                ...
                <TooltipContent side="bottom" className="max-w-[220px]">
                  <p className="text-sm">Mốc thời gian là các điểm quan trọng cần hoàn thành (VD: ra mắt, đánh giá...)</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-[200px]">
                  <p className="text-sm">Các chỉ số KPI cần đạt được (VD: lượt tiếp cận, tương tác...)</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
