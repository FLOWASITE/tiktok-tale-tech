...
const channelIcons: Record<Channel, React.ReactNode> = {
  ...
  shopify: <WordPressIcon className="w-3.5 h-3.5 xs:w-4 xs:h-4" />,
  wix: <WordPressIcon className="w-3.5 h-3.5 xs:w-4 xs:h-4" />,
  medium: <WordPressIcon className="w-3.5 h-3.5 xs:w-4 xs:h-4" />,
