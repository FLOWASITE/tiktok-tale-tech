...
const MemoizedWebsiteMarkdown = React.memo(({ content, themeColor }: { content: string; themeColor: string }) => (
  <ReactMarkdown components={{
...
MemoizedWebsiteMarkdown.displayName = 'MemoizedWebsiteMarkdown';
