      ...
      <div className="relative aspect-[5/4] bg-muted/30 overflow-hidden">
        ...
        {profile.reference_image_url && onGenerateAvatar && (
          <button
            ...
            className="absolute top-2 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 h-6 px-2 rounded-md text-[10px] font-medium bg-background/85 text-foreground/80 border border-border/60 backdrop-blur hover:bg-background transition-colors disabled:opacity-70"
          >
            {isGeneratingAvatar ? (
