...
import { Script, VIDEO_TYPE_LABELS, DURATION_LABELS, STATUS_CONFIG, SCRIPT_PURPOSE_CONFIG, ScriptPurpose, VoiceRegion, DialogueStyle, normalizePurpose } from '@/types/script';
