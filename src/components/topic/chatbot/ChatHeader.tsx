    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className={cn(
            "rounded-xl bg-primary shadow-sm",
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                {supervisorEnabled && (
                  <span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 rounded-full bg-foreground animate-pulse" />
                )}
              </Button>
            </TooltipTrigger>
                ...
                <TooltipTrigger asChild>
                  <SheetTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className={cn("h-6 w-6 sm:h-7 sm:w-7", showHistorySidebar && "bg-muted")}
                    >
