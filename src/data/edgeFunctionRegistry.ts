...
export const EDGE_FUNCTIONS: EdgeFunctionEntry[] = [
  ...
  fn('instagram-oauth-callback', 'social-oauth', 'Instagram OAuth callback', ['Instagram Graph API'], []),
  fn('facebook-oauth-callback',  'social-oauth', 'Facebook OAuth callback', ['Facebook Graph API'], []),
  fn('linkedin-oauth-callback',  'social-oauth', 'LinkedIn OAuth callback', ['LinkedIn API'], []),
  fn('threads-oauth-callback',   'social-oauth', 'Threads OAuth callback', ['Threads API'], []),
  fn('zalo-oauth-callback',      'social-oauth', 'Zalo OAuth callback', ['Zalo API'], []),
  fn('google-business-oauth-callback','social-oauth','Google Business OAuth callback', ['Google Business API'], []),
  fn('x-oauth-callback',         'social-oauth', 'X/Twitter OAuth callback', ['X API'], []),
  ...
  // ── Social Testing ──
  fn('test-instagram-connection',   'social-test', 'Test kết nối Instagram', ['Instagram Graph API'], []),
  fn('test-instagram-credentials',  'social-test', 'Test credentials Instagram', ['Instagram Graph API'], []),
  fn('test-facebook-connection',    'social-test', 'Test kết nối Facebook', ['Facebook Graph API'], []),
  fn('test-facebook-credentials',   'social-test', 'Test credentials Facebook', ['Facebook Graph API'], []),
  fn('test-linkedin-connection',    'social-test', 'Test kết nối LinkedIn', ['LinkedIn API'], []),
  fn('test-linkedin-credentials',   'social-test', 'Test credentials LinkedIn', ['LinkedIn API'], []),
  fn('test-threads-connection',     'social-test', 'Test kết nối Threads', ['Threads API'], []),
  fn('test-threads-credentials',    'social-test', 'Test credentials Threads', ['Threads API'], []),
  fn('test-twitter-connection',     'social-test', 'Test kết nối X/Twitter', ['X API'], []),
  fn('test-twitter-credentials',    'social-test', 'Test credentials X/Twitter', ['X API'], []),
  fn('test-zalo-connection',        'social-test', 'Test kết nối Zalo', ['Zalo API'], []),
  fn('test-zalo-credentials',       'social-test', 'Test credentials Zalo', ['Zalo API'], []),
  fn('test-google-business-connection','social-test','Test kết nối Google Business', ['Google Business API'], []),
  fn('test-google-business-credentials','social-test','Test credentials Google Business', ['Google Business API'], []),
  fn('test-website-connection',     'social-test', 'Test kết nối website', ['WordPress API'], []),
  fn('test-website-credentials',    'social-test', 'Test credentials website', ['WordPress API'], []),
