...
const CHANNEL_META: Record<Channel, { label: string; icon: React.ReactNode; color: string }> = {
  ...
  pinterest: { label: "Pinterest", icon: <PinterestIcon className="w-3.5 h-3.5" />, color: "text-[#E60023]" },
  ...
  wix: { label: "Website", icon: <Globe className="w-3.5 h-3.5" />, color: "text-emerald-600" },
  medium: { label: "Website", icon: <Globe className="w-3.5 h-3.5" />, color: "text-emerald-600" },
