...
import { Loader2, Copy, Download, CalendarIcon, DollarSign, Receipt, CheckCircle, CreditCard } from "lucide-react";
  ...
  if (!orgId) {
    return (
      <p className="text-sm text-muted-foreground text-center py-8">
        Vui lòng chọn workspace để xem lịch sử thanh toán.
      </p>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="flex items-center gap-3 rounded-lg border p-4">
          <div className="p-2 rounded-md bg-blue-100 dark:bg-blue-900"><Receipt className="h-4 w-4 text-blue-600 dark:text-blue-300" /></div>
          <div>
        ...
        <div className="flex items-center gap-3 rounded-lg border p-4">
          <div className="p-2 rounded-md bg-green-100 dark:bg-green-900"><CheckCircle className="h-4 w-4 text-green-600 dark:text-green-300" /></div>
          <div>
        ...
        <div className="flex items-center gap-3 rounded-lg border p-4">
          <div className="p-2 rounded-md bg-purple-100 dark:bg-purple-900"><DollarSign className="h-4 w-4 text-purple-600 dark:text-purple-300" /></div>
          <div>
