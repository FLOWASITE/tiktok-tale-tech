...
export type SocialPlatform = 'twitter' | 'facebook' | 'instagram' | 'threads' | 'linkedin' | 'tiktok' | 'youtube' | 'zalo_oa' | 'google_business' | 'blogger' | 'wordpress' | 'wordpress_com' | 'website' | 'pinterest' | 'bluesky' | 'shopify';
