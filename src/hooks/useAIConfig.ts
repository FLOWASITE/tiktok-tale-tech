...
export const MODEL_INFO: Record<string, ModelInfo> = {
  ...
  'openai/gpt-5.4': {
    shortName: 'GPT-5.4',
    description: 'OpenAI flagship mới nhất',
    speed: 'medium',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Phân tích phức tạp', 'Nội dung cao cấp'],
    provider: 'openrouter',
  },
  'openai/gpt-5.4-pro': {
    shortName: 'GPT-5.4 Pro',
    description: 'OpenAI flagship pro, reasoning mạnh',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Reasoning', 'Tác vụ phức tạp'],
    provider: 'openrouter',
  },
  'openai/gpt-5.2': {
    shortName: 'GPT-5.2',
    description: 'OpenAI reasoning nâng cao',
    speed: 'medium',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Reasoning', 'Phân tích'],
    provider: 'openrouter',
  },
  'x-ai/grok-4.20-beta': {
    shortName: 'Grok 4.20',
    description: 'xAI Grok flagship, reasoning mạnh',
    speed: 'medium',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Reasoning', 'Coding', 'Phân tích'],
    provider: 'openrouter',
  },
  'anthropic/claude-sonnet-4.6': {
    shortName: 'Claude Sonnet 4.6',
    description: 'Anthropic flagship, cân bằng tốt',
    speed: 'medium',
    quality: 'premium',
    cost: 'medium',
    bestFor: ['Nội dung dài', 'Phân tích', 'Coding'],
    provider: 'openrouter',
    isRecommended: true,
  },
  'anthropic/claude-opus-4.6': {
    shortName: 'Claude Opus 4.6',
    description: 'Anthropic mạnh nhất',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Tác vụ phức tạp nhất', 'Research'],
    provider: 'openrouter',
  },
  'anthropic/claude-haiku-4.5': {
    shortName: 'Claude Haiku 4.5',
    description: 'Anthropic nhanh, tiết kiệm',
    speed: 'fast',
    quality: 'high',
    cost: 'low',
    bestFor: ['Tác vụ nhanh', 'Khối lượng lớn'],
    provider: 'openrouter',
  },
  'deepseek/deepseek-v3.2': {
    shortName: 'DeepSeek V3.2',
    description: 'DeepSeek flagship, coding & reasoning',
    speed: 'medium',
    quality: 'premium',
    cost: 'low',
    bestFor: ['Coding', 'Reasoning', 'Tiết kiệm'],
    provider: 'openrouter',
  },
  'deepseek/deepseek-r1': {
    shortName: 'DeepSeek R1',
    description: 'DeepSeek reasoning chuyên sâu',
    speed: 'slow',
    quality: 'premium',
    cost: 'low',
    bestFor: ['Reasoning', 'Toán học', 'Logic'],
    provider: 'openrouter',
  },
  'moonshotai/kimi-k2.5': {
    shortName: 'Kimi K2.5',
    description: 'MoonshotAI flagship, context dài',
    speed: 'medium',
    quality: 'premium',
    cost: 'medium',
    bestFor: ['Context dài', 'Phân tích'],
    provider: 'openrouter',
  },
  'minimax/minimax-m2.5': {
    shortName: 'MiniMax M2.5',
    description: 'MiniMax flagship, đa năng',
    speed: 'medium',
    quality: 'high',
    cost: 'medium',
    bestFor: ['Đa năng', 'Nội dung'],
    provider: 'openrouter',
  },
  'z-ai/glm-5': {
    shortName: 'GLM-5',
    ...
    quality: 'high',
    cost: 'medium',
    bestFor: ['Đa năng', 'Tiếng Trung'],
    provider: 'openrouter',
  },
  'google/gemini-3.1-pro-preview': {
    shortName: 'Gemini 3.1 Pro',
    description: 'Google thế hệ mới nhất',
    speed: 'medium',
    quality: 'premium',
    cost: 'medium',
  ...
  'google/gemini-3-flash-preview': {
    ...
    description: 'Google nhanh thế hệ mới',
    speed: 'fast',
    quality: 'high',
    cost: 'low',
    bestFor: ['Nhanh', 'Tiết kiệm'],
    provider: 'openrouter',
  },
  'meta-llama/llama-3.3-70b-instruct': {
    ...
    quality: 'high',
    cost: 'low',
    bestFor: ['Open-source', 'Đa năng'],
    provider: 'openrouter',
  },
  'qwen/qwen3.5-397b-a17b': {
    shortName: 'Qwen 3.5 397B',
    description: 'Qwen flagship lớn nhất',
    speed: 'slow',
    quality: 'premium',
    cost: 'medium',
    bestFor: ['Reasoning', 'Tiếng Trung/Việt'],
    provider: 'openrouter',
  },
  'inception/mercury-2': {
    shortName: 'Mercury 2',
    description: 'Inception AI, tốc độ cực nhanh',
    speed: 'fast',
    quality: 'high',
    cost: 'low',
    bestFor: ['Tốc độ', 'Latency thấp'],
    provider: 'openrouter',
  },
