...
export const AI_FUNCTIONS = [
  ...
  { name: 'regenerate-carousel-caption', description: 'Tạo lại Caption & CTA cho carousel', category: 'content', type: 'text' as AIFunctionType, currentModel: 'google/gemini-2.5-flash' },
  ...
  { name: 'suggest-strategy', description: 'Gợi ý chiến lược nội dung (key messages, CTA)', category: 'agent', type: 'text' as AIFunctionType, currentModel: 'google/gemini-3-flash-preview' },
  { name: 'suggest-objectives', description: 'Gợi ý mục tiêu & KPI cho Campaign', category: 'agent', type: 'text' as AIFunctionType, currentModel: 'google/gemini-2.5-flash' },
  ...
  { name: 'import-brand-extractor', description: 'Import brand: AI trích xuất profile từ markdown/posts', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'deepseek-chat' },
  { name: 'import-brand-from-website', description: 'Import brand: orchestrator scrape website (Firecrawl)', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'deepseek-chat' },
  { name: 'import-brand-from-fanpage', description: 'Import brand: orchestrator đọc Facebook Fanpage', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'deepseek-chat' },
  { name: 'suggest-products-from-website', description: 'Gợi ý sản phẩm/dịch vụ từ website (refetch tay)', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'deepseek-chat' },
...
export const MODELS_BY_TYPE: Record<AIFunctionType, string[]> = {
  ...
  image: [
    ...
    // PoYo.ai models — Nano Banana
    'poyo/nano-banana',
    'poyo/nano-banana-pro',
    'poyo/nano-banana-2',
    ...
    'poyo/gpt-image-1',
    'poyo/gpt-image-1-edit',
    'poyo/gpt-image-1.5',
    'poyo/gpt-image-1.5-official',
    'poyo/gpt-image-1.5-official-edit',
    'poyo/gpt-image-2',
    'poyo/gpt-image-2-edit',
    // PoYo.ai — Flux
    'poyo/flux-2-pro',
    'poyo/flux-2-pro-edit',
    'poyo/flux-2-flex',
    'poyo/flux-2-flex-edit',
    'poyo/flux-kontext-pro',
    'poyo/flux-kontext-max',
    // PoYo.ai — Seedream
    'poyo/seedream-4',
    'poyo/seedream-4-edit',
    'poyo/seedream-4.5',
    'poyo/seedream-4.5-edit',
    'poyo/seedream-5.0-lite',
    'poyo/seedream-5.0-lite-edit',
    // PoYo.ai — Wan / Kling / Others
    'poyo/wan-2.7-image',
    'poyo/wan-2.7-image-pro',
    'poyo/kling-o1',
    'poyo/kling-o3',
    'poyo/z-image',
    'poyo/grok-imagine',
  ...
  video: [
    ...
    // GeminiGen — Sora (OpenAI)
    'geminigen/sora-2',
    'geminigen/sora-2-pro',
    'geminigen/sora-2-hd',
    // GeminiGen — Grok (xAI)
    'geminigen/grok-3',
    // GeminiGen — Bytedance Seedance 2.0
...
export const MODEL_INFO: Record<string, ModelInfo> = {
  ...
  'xiaomi/mimo-v2-flash': {
    ...
    description: 'Xiaomi reasoning model, nhanh & rẻ',
    speed: 'fast',
    quality: 'high',
    cost: 'low',
    bestFor: ['Coding', 'Reasoning', 'Chi phí thấp'],
  ...
  'deepseek/deepseek-chat-v3.1': {
    ...
    description: 'DeepSeek chat optimized',
    speed: 'fast',
    quality: 'high',
    cost: 'low',
    bestFor: ['Chat', 'Chi phí thấp'],
    provider: 'openrouter',
  },
  'deepseek/deepseek-r1': {
    shortName: 'DeepSeek R1',
    description: 'Reasoning chuyên sâu',
    speed: 'slow',
    quality: 'premium',
    cost: 'low',
    bestFor: ['Reasoning', 'Toán học'],
    provider: 'openrouter',
  },
  'qwen/qwen3-235b-a22b-2507': {
    shortName: 'Qwen3 235B',
    description: 'MoE 235B, reasoning mạnh',
    speed: 'medium',
    quality: 'premium',
    cost: 'low',
  ...
  'openai/gpt-oss-120b': {
    ...
    description: 'Open-source flagship OpenAI',
    speed: 'medium',
    quality: 'premium',
    cost: 'medium',
  ...
  'geminigen/sora-2-pro': {
    ...
    description: 'Sora 2 Pro — chất lượng cao hơn, prompt adherence tốt hơn',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Cinematic premium', 'Long-form storytelling'],
    provider: 'geminigen',
  },
  'geminigen/sora-2-hd': {
    shortName: 'Sora 2 HD',
    description: 'Sora 2 HD — output 1080p sắc nét',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['HD video', 'Master shot'],
    provider: 'geminigen',
  },
  'poyo/veo-3.1': {
    shortName: 'PoYo Veo 3.1',
    description: 'Veo 3.1 qua PoYo.ai — bản cải tiến mới nhất',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Video mới nhất qua PoYo', 'High fidelity'],
    provider: 'poyo',
  },
  'poyo/veo-3.1-fast': {
    shortName: 'PoYo Veo 3.1 Fast',
    description: 'Veo 3.1 Fast qua PoYo.ai',
    speed: 'fast',
    quality: 'high',
    cost: 'medium',
    bestFor: ['Video nhanh mới qua PoYo', 'Preview'],
    provider: 'poyo',
  },
  'poyo/sora-2-pro': {
    shortName: 'PoYo Sora 2 Pro',
    description: 'Sora 2 Pro qua PoYo.ai — premium quality',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Cinematic premium qua PoYo'],
    provider: 'poyo',
  },
  'poyo/kling-2.1': {
    shortName: 'PoYo Kling 2.1',
    description: 'Kling 2.1 — chuyển động mượt, phù hợp character video',
    speed: 'medium',
    quality: 'high',
    cost: 'medium',
    bestFor: ['Character animation', 'Motion smooth'],
    provider: 'poyo',
  },
  'poyo/kling-2.1-pro': {
    shortName: 'PoYo Kling 2.1 Pro',
    description: 'Kling 2.1 Pro — chất lượng nâng cao, dynamic camera',
    speed: 'slow',
    quality: 'premium',
    cost: 'high',
    bestFor: ['Premium character video', 'Camera work'],
    provider: 'poyo',
  },
  'poyo/hailuo-02': {
    shortName: 'PoYo Hailuo 02',
    description: 'Hailuo 02 (Minimax) qua PoYo — fast & affordable',
    speed: 'fast',
    quality: 'high',
    cost: 'low',
    bestFor: ['Cost-effective', 'Quick iteration'],
    provider: 'poyo',
  },
  'poyo/seedance-1-pro': {
    shortName: 'PoYo Seedance 1 Pro',
    description: 'Seedance 1 Pro (ByteDance) — multi-shot, dynamic motion',
    speed: 'medium',
    quality: 'premium',
    cost: 'medium',
    bestFor: ['Multi-shot', 'Dynamic dance/sports'],
    provider: 'poyo',
  },
  // Audio models
  'elevenlabs/music-v1': {
...
export const MODELS_BY_PROVIDER: Record<string, string[]> = {
  ...
  poyo: ['poyo/nano-banana-2-new', 'poyo/nano-banana-2-new-edit', 'poyo/nano-banana-2', 'poyo/nano-banana-2-edit', 'poyo/gpt-4o-image', 'poyo/gpt-4o-image-edit', 'poyo/gpt-image-1.5', 'poyo/z-image', 'poyo/flux-2-pro', 'poyo/flux-2-pro-edit', 'poyo/flux-2-flex', 'poyo/flux-2-flex-edit', 'poyo/seedream-4.5', 'poyo/seedream-4.5-edit', 'poyo/grok-imagine', 'poyo/veo-3', 'poyo/veo-3-fast', 'poyo/veo-3.1', 'poyo/veo-3.1-fast', 'poyo/sora-2', 'poyo/sora-2-pro', 'poyo/kling-2.1', 'poyo/kling-2.1-pro', 'poyo/hailuo-02', 'poyo/seedance-1-pro'],
  dashscope: [
    // Qwen3 series (latest)
