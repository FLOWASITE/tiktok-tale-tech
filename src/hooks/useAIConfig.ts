...
export const AI_FUNCTIONS = [
  ...
  { name: 'import-brand-extractor', description: 'Import brand: AI trích xuất profile từ markdown/posts', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'qwen-plus' },
  { name: 'import-brand-from-website', description: 'Import brand: orchestrator scrape website (Firecrawl)', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'qwen-plus' },
  { name: 'import-brand-from-fanpage', description: 'Import brand: orchestrator đọc Facebook Fanpage', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'qwen-plus' },
  { name: 'suggest-products-from-website', description: 'Gợi ý sản phẩm/dịch vụ từ website (refetch tay)', category: 'brand', type: 'text' as AIFunctionType, currentModel: 'qwen-plus' },
