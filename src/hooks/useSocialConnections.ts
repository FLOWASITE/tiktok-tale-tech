...
export type SocialPlatform = 'twitter' | 'facebook' | 'instagram' | 'linkedin' | 'tiktok' | 'threads' | 'youtube' | 'zalo_oa' | 'google_business' | 'blogger' | 'wordpress' | 'wordpress_com' | 'website' | 'pinterest' | 'bluesky' | 'shopify' | 'wix' | 'medium';
