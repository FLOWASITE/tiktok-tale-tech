...
export const DEFAULT_CHANNEL_SETTINGS: Record<Channel, ChannelSettings> = {
  ...
  bluesky: {
    ...
    length_unit: 'chars',
    hook_required: true,
    hook_style: 'Mở đầu thu hút, ngắn gọn, có cá tính',
    bullet_allowed: false,
    cta_policy: 'none',
    emoji_allowed: true,
    emoji_limit: 5,
    ...
    tone_adjustment: 'concise',
    format_type: 'plain',
    format_description: 'Post ngắn ≤300 graphemes, casual, conversational, có cá tính. Tối đa 4 ảnh (mỗi ảnh <1MB). Link đặt cuối post. KHÔNG hashtag.',
  },
};
