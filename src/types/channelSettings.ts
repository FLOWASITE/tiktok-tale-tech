...
export const DEFAULT_CHANNEL_SETTINGS: Record<Channel, ChannelSettings> = {
  website: {
    ...
    format_description: 'Website corporate: H1 + 3-4 H2, đoạn 2-3 câu súc tích, có CTA cuối bài, schema-friendly, KHÔNG dùng H3 lồng nhiều, KHÔNG TOC, KHÔNG FAQ block.',
  },
  blogger: {
    min_length: 500,
    max_length: 800,
    length_unit: 'words',
    hook_required: false,
    hook_style: 'mở bài conversational, gần gũi như đang trò chuyện',
    bullet_allowed: true,
    cta_policy: 'soft',
    emoji_allowed: false,
    emoji_limit: 0,
    ...
    tone_adjustment: 'keep',
    format_type: 'markdown',
    format_description: 'Blogger casual blog: H1 + 2 H2 (tối đa 3), 1-2 bullet list ngắn, paragraph thoáng, giọng cá nhân/personal, KHÔNG TOC, KHÔNG FAQ, KHÔNG callout box. Ngắn gọn, dễ đọc.',
  },
  wordpress: {
    min_length: 1200,
    max_length: 2000,
    length_unit: 'words',
    hook_required: false,
    hook_style: 'mở bài chuyên môn, nêu vấn đề rõ ràng',
    bullet_allowed: true,
    cta_policy: 'soft',
    emoji_allowed: false,
    emoji_limit: 0,
    ...
    tone_adjustment: 'keep',
    format_type: 'markdown',
    format_description: 'WordPress in-depth guide: H1 + 4-6 H2 + H3 lồng nhau, mở đầu bằng TOC (Mục lục dạng list link), kết thúc bằng FAQ block (3-5 câu hỏi), có callout/blockquote, gợi ý 2-3 internal links, chuyên môn sâu, dài và chi tiết.',
  },
  shopify: {
    min_length: 1200,
    max_length: 2000,
  ...
  wix: {
    ...
    length_unit: 'words',
    hook_required: false,
    hook_style: 'mở bài kể chuyện brand, nêu giá trị rõ ràng',
    bullet_allowed: true,
    cta_policy: 'optional',
    emoji_allowed: false,
    emoji_limit: 0,
  ...
  medium: {
    ...
    length_unit: 'words',
    hook_required: false,
    hook_style: 'mở bài story-first, hook mạnh, voice cá nhân/expert',
    bullet_allowed: true,
    cta_policy: 'soft',
    emoji_allowed: false,
    emoji_limit: 0,
  ...
  bluesky: {
    ...
    length_unit: 'chars',
    hook_required: true,
    hook_style: 'Câu đầu là hook sắc: hot take, observation, hoặc câu hỏi gây tò mò',
    bullet_allowed: false,
    cta_policy: 'none',
    emoji_allowed: true,
    emoji_limit: 3,
    ...
    tone_adjustment: 'concise',
    format_type: 'plain',
    format_description: 'PLAIN TEXT thuần ≤300 graphemes. KHÔNG markdown (no **bold**, # heading, - bullet, [text](url)). 2-3 đoạn rất ngắn (1-2 câu) cách nhau dòng trống. Casual, first-person, có cá tính. Emoji 0-3. KHÔNG hashtag. Link (nếu có) là URL trần dòng cuối.',
  },
};
...
export const BASE_CHANNEL_CONFIG: Record<Channel, {
  ...
  website: { label: 'Website', color: 'text-blue-400', bgColor: 'bg-blue-500/10', descriptionSuffix: 'corporate SEO' },
