...
Để thực hiện các quyền trên, liên hệ chúng tôi qua email: support@flowa.one. Chúng tôi sẽ phản hồi trong vòng 15 ngày làm việc.`,
  ...
  {
    icon: Share2,
    title: "7. Chia sẻ thông tin",
    content: `**7.1. Chúng tôi KHÔNG bán dữ liệu cá nhân của bạn.**

**7.2. Chia sẻ giới hạn**
...
- **Social media tokens:** Xóa ngay lập tức khi bạn nhấn "Disconnect" tại trang Connections.
- **Publishing logs:** Lưu 90 ngày sau đó anonymize (giữ metric tổng hợp, xóa nội dung post).
...
- **Dữ liệu ẩn danh:** Có thể được giữ vô thời hạn cho mục đích nghiên cứu và cải thiện sản phẩm.`,
  ...
  {
    icon: Bell,
    title: "9. Cookie và theo dõi",
    content: `**9.1. Các loại cookie**
