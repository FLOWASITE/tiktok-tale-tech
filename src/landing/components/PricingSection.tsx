...
export function PricingSection() {
  return (
    <section id="pricing" className="py-16 lg:py-24 bg-[#09090b]">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          ...
          <p className="text-gray-400">Bắt đầu miễn phí. Upgrade khi bạn sẵn sàng scale.</p>
        </motion.div>
          ...
          {plans.map((plan, i) => (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-500">{plan.priceSub}</p>
              </div>

              <div className="text-3xl font-extrabold text-white mb-5">{plan.price}</div>
